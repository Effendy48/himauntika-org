...
<head>
    ...
    <title>Himauntika Panel Administration</title>
...
<body>
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li><a href="index.php"><i class="menu-icon fa fa-laptop"></i>Dashboard </a></li>
                    ...
                    <li class="menu-title">Admininstrator</li><!-- Menu Title-->
                    <li class="menu-item-has-children dropdown">
    ...
    <div id="right-panel" class="right-panel">
                ...
                <div class="header-menu">
                    ...
                    <div class="user-area dropdown float-right">
                        ...
                        <div class="user-menu dropdown-menu">
                            ...
                            <a class="nav-link" href="pages/dashboard/logout.php"><i class="fa fa-power -off"></i>Logout</a>
                        </div>
                    </div>
        ...
        <div class="content">
            ...
            <?php 
                if(!@$_GET['p']){
                    include "pages/dashboard/widget.php";
                }else{
                    include "../page.php";
                }
            ?>  
